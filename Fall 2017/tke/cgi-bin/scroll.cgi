...
#Main loop
   ...
   if ($Form{'bbro'} ne '') {
      ...
      print "<center><b><font color=000000 size=+1>",$title," - Big Brother Lineage</font></b></center><br>\n";
      ...
      if ($Form{'tree'} eq 'all') {
        ...
        print "<center><b><font color=000000 size=+1>",$title," - Entire Chapter Tree</font></b></center><br>\n";
      ...
      else
      {
        ...
        print "<center><b><font color=000000 size=+1>",$title," - Family Tree</font></b></center><br>\n";
        print "<!-- tree=", $Form{'tree'}, " -->\n";
        &find_name_and_bbro($scroll_num);
      ...
      if ($Form{'scroll'} eq 'actives') {
        #Actives only scroll
        #print "<center><b><font color=000000 size=+1>Jugdish's Scroll-o-matic!</font></b></center><br>\n";
        print "<center><b><font color=000000 size=+1>",$title," - Actives</font></b></center><br><br>\n";
        ...
        #Error handling
        print "<center><b><font color=ffffff size=+1>",$title," - Error</font></b></center><br>\n";
      ...
      #Info report
      print "<center><b><font color=ffffff size=+1>",$title," - Info</font></b></center><br>\n";
      print "<center><b>About this Application</b></center><br><br>\n";
      print "<blockquote>\n";
      print "<b>What family trees from the original founders are still active?</b>&nbsp;&nbsp;The only family trees that are still active are descendants of <a href=",$script_name,"?tree=008>Pat O'Roark</a>, <a href=",$script_name,"?tree=009>Robert Romeo</a>, and <a href=",$script_name,"?tree=014>Terry Westbrook</a>.<br>\n";
      ...
      print "<br>\n";
      print "<b>Why are some names like Xxx Xxxx?  Are these missing names?</b>&nbsp;&nbsp;There are some names that have been struck from the scroll because these people demitted.<br>\n";
      ...
      #Error handling
      #print "<center><b><font color=ffffff size=+1>Jugdish's Scroll-o-matic!</font></b></center><br>\n";
...
sub print_hdr {
  ...
  print "<body BGCOLOR='#FFFFFF' TEXT='#000000' LINK='#CCCCCC' VLINK='#CCCCCC'>\n\n";
...
sub print_scroll {
    ...
    print "<tr><td align=center valign=bottom><b><font color=000000> Scroll </font></b></td><td align=center valign=bottom><b><font color=000000>Frater</font></b></td><td align=center valign=bottom><b><font color=000000>Nickname</font></b></td><td align=center valign=bottom><b><font color=000000>Big Brother</font></b></td><td align=center valign=bottom><b><font color=000000> Lineage </font></b></td><td align=center valign=bottom><b><font color=000000> Family Tree </font></b></td></tr>\n";
    for ($i = 1; $i <= $num_recs; $i++)
    {
      ...
      #print name
      if ($scroll_arry[$i][4] eq "AC") {
        print "<font color=ff0000>",$scroll_arry[$i][2],"</font>";
      }
      else {
      ...
      #print nickname
      if ($scroll_arry[$i][4] eq "AC") {
        print "<font color=ff0000>",$scroll_arry[$i][5],"</font>";
      }
      else {
      ...
      if ($scroll_arry[$i][3] eq "FOU")
      ...
      else
        {
          if ($scroll_arry[$i][7] eq "AC") {
            print "<font color=ff0000>",$scroll_arry[$i][6],"</font>";
          }
          else {
...
sub print_ftr {
  print "<center>Names in <font color=ff0000>red</font> are Active fraters.</center><br>\n";
...
sub print_name_and_bbro {
  ...
  if ($bbro_num_out eq "FOU"){
    ...
    if ($status_out eq "AC"){print "<font color=000000>";}
    ...
    if ($bbro_status_out eq "AC"){print "<font color=000000>";}
...
sub print_ftree {
      ...
      if ($rtype eq 'all') {
        ...
        print "<tr><td><nobr><font face=Arial size=-1><img src='clr.gif' align='left' border='0' vspace='0' hspace='0' width='1' height='18'>";
        if ($status_out eq "AC"){print "<font color=ff0000>";}
      ...
      for ($i = 1; $i <= $num_branches; $i++) {
         ...
         #print name, etc
         if ($tree_arry[$i][4] eq "AC") {$num_act_branches++; print "<font color=ff0000>";}
